...
typedef struct scope_gui_basic_parameters
{
    ...
    */
    ...
    /*
        ...
        Общий размер - 23 на 15 единиц (по 50 пикселей в единице)

        - Задник (3 части - верхняя, средняя, нижняя)
            - Верхняя часть - 23 на 1 единицу
            - Средняя часть - 23 на 13 единиц
            - Нижняя часть - 23 на 1 единицу

        - Дисплей - 17 на 9 единиц (находится с отступами в 1 единицу от левого и верхнего края задника)
        - Сетка (9 горизонтальных линий + 17 вертикальных линий)
            - Все линии сетки - 17 на 9 единиц (находятся внутри дисплея без отступов)
