...
Этот документ я писал самостоятельно при второй чистовой релизации программы, чтобы понимать, что вообще мне делать. 

Это было до глобального дебага / добивания, через claude code. Он немного неактуален, но содержит много полезного, относительно более актуального дока.

Рядом в этой же папке лежит guideline от клауд кода по актуальной версии с несколькими изменениями некоторых функций от него (он почти актуален, почти, т.к. я за ним немного переписывал функцию рендера сигнала)

Эти два дока будут скрещены в 1 нормальный гайдлайн чуточку позже, как дойдут лапы.
